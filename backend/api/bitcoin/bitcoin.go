...
func GetDestinationAddress(peerInfo peer.AddrInfo) (string, error) {
	stream, err := global.DHTNode.Host.NewStream(global.DHTNode.Ctx, peerInfo.ID, handlers.WalletAddressReqHandler)
	if err != nil {
