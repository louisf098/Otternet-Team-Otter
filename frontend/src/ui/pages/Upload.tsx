...
const Upload: React.FC<UploadProps> = ({
  ...
  const handleFormSubmit = async (data: SubmitData) => {
    ...
    try {
      ...
      setSnackbarMessage(
        "The following error occurred when attempting to upload the file: " +
      ...
      <Box sx={{ m: 1, p: 2, width: "100%", maxWidth: "500px" }}>
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)}>
          <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
            ...
            />
            <Tooltip
              title="Whenever someone downloads your file, you will receive the price you set."
              arrow
            >
              <IconButton>
          ...
          <FormControl fullWidth sx={{ mb: 2 }}>
            ...
            <Controller
              ...
              render={({ field }) => (
                <RadioGroup {...field} aria-labelledby="bundle-mode-label" row>
                  <FormControlLabel
                    value="No bundle"
                    control={<Radio />}
                    label="No bundle"
